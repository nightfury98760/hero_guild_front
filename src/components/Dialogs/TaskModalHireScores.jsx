...
const TaskModalHireScores = ({ isOpen, onClose, onNext}) => {
      ...
      <div className="flex flex-col bg-neutral-800 backdrop-blur-sm w-screen bg-opacity-70 rounded-t-[24px] pb-6">
        <div className="flex-col flex  p-6 font-bold text-white items-center justify-start">
          ...
          <div>
            <img
              className=""
              src="/assets/imgs/HireScores.png"
              width={180}
              alt="task-logo"
            />
          </div>
          ...
          <div className="text-center flex items-center gap-1 pt-5 text-[12px]">
            The more tasks you complete, the more GOH Coins you earn. Track your
            progress and see where you stand by checking the highscores. Here,
            you can view your rank and the total amount of GOH Coins you've
            accumulated. Engage more to climb higher and earn greater rewards
          </div>
          <div
            id="btn"
...
export default TaskModalHireScores;
